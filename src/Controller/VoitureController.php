...
class VoitureController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/edit", name="voiture_louer", methods={"GET","POST"})
     */
    public function louer(Request $request, Voiture $voiture): Response
    {
        $form = $this->createForm(VoitureType::class, $voiture);
        $form->handleRequest($request);
    ...
    /**
     * @Route("/{id}/edit", name="voiture_rendre", methods={"GET","POST"})
     */
    public function rendre(Request $request, Voiture $voiture): Response
    {
        $form = $this->createForm(VoitureType::class, $voiture);
        $form->handleRequest($request);
